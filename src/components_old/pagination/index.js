...
class Pagination extends PaginationPrototype {
  ...
  getNewLocation = (page) => {
    ...
    const newLocation = router.createLocation(location)
  ...
  render() {
    const { show, page, limit, total } = this.props
    ...
    if (page > 1) {
      ...
      rows.push(
        <li key="page-1-0" className="control">
          <Link style={paginationItemStyle} to={href} href={href}>
            «
          </Link>
        </li>
      )
    ...
    if (page < pages) {
      ...
      rows.push(
        <li key={'page-' + pages + '-0'} className="control">
          <Link style={paginationItemStyle} href={href} href={href}>
            »
          </Link>
        </li>
      )
