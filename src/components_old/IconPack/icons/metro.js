...
export default class MetroIcon extends Component {
  ...
  render() {
    ...
    return (
      <SvgIcon viewBox="0 0 95.44 95.441" {...other}>
        <g>
          <g>
            <path
              d="M47.721,11.712C21.366,11.712,0,33.281,0,59.888c0,14.427,6.226,23.836,6.226,23.836l82.97,0.004
            ...
            />
            <polygon
              points="61.207,24.505 60.608,24.504 47.879,49.447 34.692,24.291 16.637,69.736 11.971,69.736 11.971,73.386 
