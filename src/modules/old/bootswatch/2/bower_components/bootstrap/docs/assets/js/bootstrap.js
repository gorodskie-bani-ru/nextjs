...
!(function ($) {
  ...
  Collapse.prototype = {
    ...
    show: function () {
      let dimension, scroll, actives, hasData
...
!(function ($) {
  ...
  Dropdown.prototype = {
    ...
    keydown: function (e) {
      let $this, $items, $active, $parent, isActive, index
...
!(function ($) {
  ...
  Tooltip.prototype = {
    ...
    init: function (type, element, options) {
      let eventIn, eventOut, triggers, trigger, i
    ...
    enter: function (e) {
      let defaults = $.fn[this.type].defaults,
        options = {},
        self
