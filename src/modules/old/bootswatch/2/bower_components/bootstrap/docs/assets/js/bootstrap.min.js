...
!(function (e) {
    ...
    t.prototype = {
      ...
      slide: function (t, n) {
        ...
        this.$indicators.length &&
          ...
          this.$element.one('slid', function () {
            const t = e(a.$indicators.children()[a.getActiveIndex()])
            t && t.addClass('active')
          }))
  ...
  !(function (e) {
    ...
    t.prototype = {
      ...
      show: function () {
        const t = e.extend({}, this.$element.position(), {
