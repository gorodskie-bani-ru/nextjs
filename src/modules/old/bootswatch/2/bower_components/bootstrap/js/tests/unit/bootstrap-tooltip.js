$(function () {
  ...
  test('should place tooltips relative to placement option', function () {
    ...
    const tooltip = $('<a href="#" rel="tooltip" title="Another tooltip"></a>')
  ...
  test('should allow html entities', function () {
    $.support.transition = false
    const tooltip = $('<a href="#" rel="tooltip" title="<b>@fat</b>"></a>')
      .appendTo('#qunit-fixture')
      .tooltip({ html: true })
      .tooltip('show')
  ...
  test('should fire show event', function () {
    stop()
    const tooltip = $('<div title="tooltip title"></div>')
      .bind('show', function () {
  ...
  test('should destroy tooltip', function () {
    ...
    ok(
      $._data(tooltip[0], 'events').click[0].namespace == 'foo',
