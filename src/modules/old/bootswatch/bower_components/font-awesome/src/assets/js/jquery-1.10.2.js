...
setDocument = Sizzle.setDocument = function( node ) {
	...
	function( a, b ) {
		...
		const compare = b.compareDocumentPosition && a.compareDocumentPosition && a.compareDocumentPosition( b );
...
jQuery.support = (function( support ) {
	...
	let all, a, input, select, fragment, opt, eventName, isSupported, i,
...
jQuery.each( jQuery.expr.match.bool.source.match( /\w+/g ), function( i, name ) {
	const getter = jQuery.expr.attrHandle[ name ] || jQuery.find.attr;
...
function defaultPrefilter( elem, props, opts ) {
	...
	let prop, value, toggle, tween, hooks, oldfire,
		anim = this,
		orig = {},
		style = elem.style,
