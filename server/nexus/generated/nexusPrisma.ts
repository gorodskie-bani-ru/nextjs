...
interface NexusPrismaInputs {
  Query: {
    ...
    bani684Userss: {
      ...
      ordering: 'id' | 'username' | 'password' | 'cachepwd' | 'class_key' | 'active' | 'remote_key' | 'remote_data' | 'hash_class' | 'salt' | 'primary_group' | 'session_stale' | 'sudo' | 'createdon' | 'delegate' | 'offer' | 'offer_date' | 'contract_date' | 'createdby' | 'Attributes' | 'Resources' | 'bani684_society_comments' | 'bani684_society_votes'
    }
    bani684UserAttributess: {
      ...
      ordering: 'id' | 'internalKey' | 'fullname' | 'email' | 'phone' | 'mobilephone' | 'blocked' | 'blockeduntil' | 'blockedafter' | 'logincount' | 'lastlogin' | 'thislogin' | 'failedlogincount' | 'sessionid' | 'dob' | 'gender' | 'address' | 'country' | 'city' | 'state' | 'zip' | 'fax' | 'photo' | 'comment' | 'website' | 'extended' | 'User'
    }
