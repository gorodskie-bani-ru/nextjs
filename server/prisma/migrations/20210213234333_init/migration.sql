...
CREATE TABLE `bani684_context_setting` (
    ...
    `editedon` DATETIME(3) NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `bani684_manager_log` (
    ...
    `occurred` DATETIME(0) DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `bani684_user_messages` (
    ...
    `date_sent` DATETIME(0) NOT NULL DEFAULT '0000-00-00 00:00:00',
